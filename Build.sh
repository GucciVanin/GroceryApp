...
versionID="22.8.13.1" #.1 added by Steven Cooper (Minor tweak to executable name)
...
executableFileName="${PWD##*/}" # Set the executable's name to match the folder the source code files were in
...
g++ --version
if $GccCommand -include "${complianceHelperFile_path}" -o "${executableFileName}_gcc"  "${sourceFiles[@]}"; then
